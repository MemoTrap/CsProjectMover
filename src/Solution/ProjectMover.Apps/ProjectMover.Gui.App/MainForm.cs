...
namespace ProjectMover.Gui.App {
  ...
  public partial class MainForm : Form {
    ...
    public MainForm () {
      ...
      Callback = new Callback (this, () => CancellationTokenSource);
    ...
    private void ckBoxRescan_CheckedChanged (object sender, EventArgs e) {
      ...
      Parameters.Rescan = ckBoxRescan.Checked;
      enable ();
    }
    ...
    private void enable () {
      ...
      setToolTips (multiProjects, multiSolutions);
    ...
    private void setToolTips (bool multiProjects, bool multiSolutions) {
      toolTip.SetToolTip (labelRoot, toolTip.GetToolTip (txtBoxRoot));
      if (Parameters.Copy) {
      ...
      toolTip.SetToolTip (labelDest, toolTip.GetToolTip (txtBoxDest));
      ...
      toolTip.SetToolTip (labelProj, toolTip.GetToolTip (txtBoxProj));
      ...
      toolTip.SetToolTip (labelSln, toolTip.GetToolTip (txtBoxSln));
    }
