// From project https://github.com/audiamus/BookLibConnect
// Copyright (C) 2021 - 2023 by audiamus
// Copyright (C) 2003 by Prosoft-Lanz, JCL
// Original License: Code Project
// Relicensed under the GNU General Public License v3.0 (GPL-3.0)
...
namespace core.audiamus.aux.win 
{
	...
	public sealed class DlgBox
	{
		...
		{
      CenterWindow centerWindow = new(IntPtr.Zero);
		...
		public static DialogResult ShowDialog(CommonDialog dlg, IWin32Window owner)
		{
			...
			CenterWindow centerWindow = new(handle);
			DialogResult dlgResult = dlg.ShowDialog();
			centerWindow.Dispose();
			return dlgResult;
		}
    ...
    public static DialogResult Show (string text) {
      ...
      if (IsMono) {
        return MessageBox.Show (text, caption,
          default, default,
          default, (MessageBoxOptions)0x40000);
      } else {
        CenterWindow centerWindow = new(IntPtr.Zero);
    ...
    public static DialogResult Show(IWin32Window owner, string text, string caption)
      ...
      if (IsMono) {
        return MessageBox.Show (text, caption, buttons,
          default, default, (MessageBoxOptions)0x40000);
      } else {
        CenterWindow centerWindow = new(IntPtr.Zero);
	...
	internal sealed class CenterWindow
	{
		...
		public void WndActivate(object sender, CbtEventArgs e)
		{
			...
			RECT rectDlg = new();
			_ = USER32.GetWindowRect(hMsgBox, ref rectDlg);

			// get the owner window rect
			RECT rectForm = new();
			_ = USER32.GetWindowRect(hOwner, ref rectForm);
			...
			if (e.IsDialog)
			{
				...
				_ = USER32.MoveWindow(hMsgBox, rect.Left, rect.Top, rect.Width, rect.Height, 1);
		...
		public void WndProcRet(object sender, WndProcRetEventArgs e)
		{
			...
			{
        _ = USER32.MoveWindow(e.cw.hwnd, rect.Left, rect.Top, rect.Width, rect.Height, 1);
