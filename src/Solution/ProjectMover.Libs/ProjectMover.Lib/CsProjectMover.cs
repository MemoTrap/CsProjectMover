    ...
    public async Task<bool> RunAsync (
      ...
      return await Task.Run (async () => {
        ...
        try {
          ...
          // STEP 1
          var projectCandidates = await step1_FindProjectCandidatesAsync (
            parameters, 
            cancellationToken
          );
          ...
          // STEP 2
          var dependencies = await step2_FindDependingSolutionsAndProjectsAsync (
            parameters, 
            projectCandidates, 
            cancellationToken
          );
          ...
          // STEP 3
          var plans = step3_UserInteraction (
            parameters, 
            projectCandidates, 
            dependencies, 
            cancellationToken
